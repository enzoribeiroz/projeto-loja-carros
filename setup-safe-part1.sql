-- =====================================================
-- PARTE 1 SEGURA: CONFIGURAÇÃO BÁSICA (SEM CONFLITOS)
-- Execute este script mesmo se as tabelas já existirem
-- =====================================================

-- 1. HABILITAR EXTENSÕES NECESSÁRIAS (seguro)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- 2. CRIAR TABELAS PRINCIPAIS (usando IF NOT EXISTS)
...
-- 3. CRIAR ÍNDICES PARA PERFORMANCE (usando IF NOT EXISTS)
...
-- 4. INSERIR DADOS INICIAIS (usando ON CONFLICT DO NOTHING)
...
-- VERIFICAÇÃO
SELECT 'PARTE 1 SEGURA CONCLUÍDA - TABELAS CRIADAS/VERIFICADAS!' as status;
